...
The remaining feature is submitted together on `codex/ptc-standalone`, based on
`main` after the Desktop module split. This replaces the review stack #1519,
#1520, and #1522; the already-merged SDK #1518 is not included again. See the
[review guide](ptc-review-closure.md#commit-review-order) for focused commits.
Merging remains a separate decision after review.
